...
\lean{COLT83.mixDesign, COLT83.designMatrix_mixDesign, COLT83.IsDesign.mixDesign, COLT83.posDef_designMatrix_mixDesign}\leanok
...
\lean{COLT83.smul_designMatrix_le_designMatrix_mixDesign_left, COLT83.smul_designMatrix_le_designMatrix_mixDesign_right, COLT83.IsGOptimalDesign.dotProduct_inv_designMatrix_mixDesign_le, COLT83.gwMat_designMatrix_mixDesign_le}\leanok
...
\textbf{Lean remark.} The mixture \texttt{COLT83.mixDesign w₁ w₂} and the two bounds are
...
\lean{COLT83.leastSquares, COLT83.designRows, COLT83.lsMatrix, COLT83.leastSquares_eq_toEuclideanLin}\leanok
...
\lean{COLT83.leastSquares_inner_add, COLT83.lsMatrix_mul_transpose, COLT83.hasLaw_leastSquares_of_fixedDesign}\leanok
...
$\hat\theta \sim \Normal(\theta, \Sigma_T^{-1})$ (\texttt{COLT83.hasLaw\_leastSquares\_of\_fixedDesign},
...
\lean{COLT83.simpleRegret_le_supportFn_add_supportFn}\leanok
\uses{def:regret}
...
\lean{COLT83.diffSup, COLT83.diffSup_eq_supportFn_add_neg, COLT83.continuous_diffSup, COLT83.integral_diffSup_multivariateGaussian, COLT83.measureReal_diffSup_gt_le}\leanok
...
\lean{COLT83.lsRecommend, COLT83.measurable_lsRecommend, COLT83.fixedDesignIdentAlg, COLT83.isFixedBudget_fixedDesignIdentAlg, COLT83.isFixedDesign_fixedDesignIdentAlg, COLT83.output_fixedDesignIdentAlg}\leanok
...
\lean{COLT83.isPAC_fixedDesignIdentAlg}\leanok
...
\textbf{Lean remark.} The formalized algorithm \texttt{COLT83.fixedDesignIdentAlg T x s}
takes the design $x$ and the selector $s$ as parameters, and
\texttt{COLT83.isPAC\_fixedDesignIdentAlg} is the guarantee in the general form ``if
...
(\texttt{COLT83.exists\_isFixedDesign\_isPAC}). Instead of a width-minimizing design
...
\lean{COLT83.lnNoise_real_norm_lnDelta_gt_le, COLT83.norm_sub_inner_normalizeBall_le}
