...
\lean{lipschitzWith_of_norm_gradient_le, abs_le_of_norm_gradient_le, abs_inner_gradient_le, ContDiff.continuous_gradient, ProbabilityTheory.IsGaussian.integrable_exp_of_norm_gradient_le, ProbabilityTheory.IsGaussian.integrable_of_norm_gradient_le}\leanok
...
\lean{innerPi, softmax, logSumExp, logSumExp_eq_comp, sum_exp_inner_pos, softmax_nonneg, sum_softmax, contDiff_logSumExp, hasGradientAt_logSumExp, norm_gradient_logSumExp_le, ciSup_inner_le_logSumExp, logSumExp_le_ciSup_inner_add}\leanok
...
\lean{hasDerivAt_comp_quarterCircle, sub_eq_integral_quarterCircle}\leanok
...
\lean{exp_mul_integral_le_integral_exp}\leanok
...
\lean{abs_ciSup_inner_le, ProbabilityTheory.measurable_ciSup_inner, ProbabilityTheory.hasSubgaussianMGF_iSup_inner_stdGaussian}\leanok
\uses{def:pg_gaussian_vector, def:pc_gaussian_constant}
...
\lean{Maiti2026Power.integral_diffSup_multivariateGaussian, Maiti2026Power.measureReal_diffSup_gt_le}\leanok
