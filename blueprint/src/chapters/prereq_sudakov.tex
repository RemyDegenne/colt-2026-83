...
SudakovFernique, GaussianMaxLower\}.lean} and \texttt{COLT83/Mathlib/Analysis/LogSumExp.lean}.
...
The soft-max is \texttt{logSumExp β (EuclideanSpace.basisFun ι ℝ)}, whose Hessian is computed
in \texttt{COLT83/Mathlib/Analysis/LogSumExp.lean} for an arbitrary finite family of vectors.
...
\lean{logSumExp, softmax, ciSup_inner_le_logSumExp, logSumExp_le_ciSup_inner_add, hasFDerivAt_logSumExp, norm_gradient_logSumExp_le, fderiv_fderiv_logSumExp_apply, norm_fderiv_fderiv_logSumExp_le, ProbabilityTheory.fderiv_fderiv_logSumExp_basisFun_single, ProbabilityTheory.sum_mul_fderiv_fderiv_logSumExp_basisFun}\leanok
