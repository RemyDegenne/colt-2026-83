...
\texttt{COLT83/Mathlib/Probability/\{SteinReal, SteinIdentity, GaussianInterpolation,
SudakovFernique, GaussianMaxLower\}.lean} and
\texttt{COLT83/Mathlib/Analysis/\{SpecialFunctions, InnerProductSpace\}/LogSumExp.lean}.
...
\texttt{Real.logSumExp} of \texttt{COLT83/Mathlib/Analysis/SpecialFunctions/LogSumExp.lean}
...
forms of \texttt{COLT83/Mathlib/Analysis/InnerProductSpace/LogSumExp.lean}.
