...
\textbf{Lean remark.} The statement is about \texttt{klDiv} of two pushforwards of
\texttt{Learning.trajMeasure} by \texttt{IT.hist n} (or, equivalently, of
\texttt{P.map (history A Y n)} for any \texttt{IsAlgEnvSeqUntil}), with the sum in
\texttt{ℝ≥0∞} of \texttt{∫⁻ h, klDiv (κ (h t).1) (κ' (h t).1) ∂P}. The hypotheses
