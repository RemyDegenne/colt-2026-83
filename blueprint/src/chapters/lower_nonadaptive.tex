...
\lean{COLT83.bayesParam, COLT83.bayesObs, COLT83.bayesHist, COLT83.bayesKernel, COLT83.bayesJoint, COLT83.map_bayesParam_stdGaussian, COLT83.map_bayesHist_stdGaussian}\leanok
...
\lean{COLT83.bayesW₁, COLT83.bayesW₂, COLT83.bayesY₁, COLT83.bayesParam_sub_smul_leastSquares, COLT83.bayesW₁_comp_adjoint_bayesY₁_add, COLT83.indepFun_bayesW_bayesY}\leanok
...
\lean{COLT83.integral_inner_bayesParamClm_bayesJoint, COLT83.integral_inner_bayesW_bayesJoint}\leanok
...
\lean{COLT83.le_integral_simpleRegret_bayesJoint, COLT83.integral_inner_bayesLSclm_le, COLT83.integral_supportFn_bayesParam, COLT83.integral_supportFn_toEuclideanLin_lsMatrix}\leanok
...
\lean{COLT83.bayesC_identity}\leanok
...
\lean{COLT83.exists_singular_instances, COLT83.exists_singular_instances_of_zero_mem, COLT83.exists_singular_instances_of_forall, COLT83.exists_ne_zero_inner_eq_zero_of_not_posDef, COLT83.diffSup_pos_of_inner_eq_zero, COLT83.simpleRegret_smul_add_simpleRegret_neg_smul}\leanok
...
\lean{COLT83.posDef_of_isFixedDesign_of_isPAC_of_forall, COLT83.posDef_of_isFixedDesign_of_isPAC, COLT83.posDef_of_isFixedDesign_of_isPAC_of_zero_mem}\leanok
...
\lean{COLT83.gwMat_le_of_isFixedDesign_of_isPAC}\leanok
