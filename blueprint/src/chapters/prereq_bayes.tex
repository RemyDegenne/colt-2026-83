...
\texttt{COLT83.likelihood\_eq\_gaussTilt} (stated on the unit ball, with
...
\lean{Learning.LinearBandit.noiseHistLaw, Learning.LinearBandit.histKernel, Learning.LinearBandit.histKernel_apply, Learning.IsAlgEnvSeq.map_finHistory_eq_histKernel, Learning.IsAlgEnvSeq.hasLaw_finHistory_histKernel, Learning.LinearBandit.pairKernel, Learning.LinearBandit.pairKernel_apply, Learning.IdentAlg.IsRun.hasLaw_finHistory_out_pairKernel, Learning.LinearBandit.IsPAC.le_measureReal_pairKernel, Learning.LinearBandit.IsPAC.integral_simpleRegret_pairKernel_le, COLT83.expRegret, COLT83.stronglyMeasurable_expRegret}\leanok
...
\lean{COLT83.integral_bayesJointLaw, COLT83.integrable_bayesJointLaw_iff, COLT83.integral_likelihood_noisePairLaw, COLT83.integrable_likelihood_noisePairLaw, COLT83.integrable_likelihood_mul_prod, COLT83.integral_likelihood_mul_prod, COLT83.integral_indicator_mul_simpleRegret_bayesJointLaw}\leanok
...
\texttt{COLT83.likelihood\_eq\_gaussTilt}.

\begin{lemma}[Posterior mean identity]\label{lem:posterior_mean}
\lean{COLT83.postU, COLT83.stronglyMeasurable_postU, COLT83.integrable_likelihood_mul_inner_prod, COLT83.integrable_norm_postU, COLT83.integral_inner_bayesJointLaw_le}\leanok
...
\lean{COLT83.postZ, COLT83.postN, COLT83.stronglyMeasurable_postZ, COLT83.stronglyMeasurable_postN, COLT83.postZ_pos, COLT83.norm_postU_sq_le, COLT83.norm_postU_le, COLT83.integrable_postZ, COLT83.integral_postZ, COLT83.integrable_postN, COLT83.integral_postN, COLT83.integral_norm_postU_le}\leanok
...
\lean{COLT83.le_trace_postCov_histS, COLT83.trace_histS_le, COLT83.posSemidef_histS}\leanok
...
\lean{COLT83.le_integral_norm_gaussPrior, COLT83.integral_norm_sq_gaussPrior, COLT83.integrable_norm_gaussPrior, COLT83.integrable_norm_sq_gaussPrior}\leanok
...
\lean{COLT83.integral_simpleRegret_bayesJointLaw_ge}\leanok
...
\lean{COLT83.simpleRegret_unitBall_nonneg, COLT83.simpleRegret_unitBall_le, COLT83.expRegret_nonneg, COLT83.expRegret_le, COLT83.integrable_expRegret, COLT83.integrable_simpleRegret_bayesJointLaw, COLT83.integral_norm_sq_bayesJointLaw, COLT83.integral_indicator_mul_simpleRegret_bayesJointLaw_ge, COLT83.le_measureReal_norm_le_gaussPrior, COLT83.exists_norm_le_and_le_expRegret, COLT83.exists_norm_le_and_le_expRegret_unitBall}\leanok
...
\lean{COLT83.unitBall_le_budget_of_isPAC, COLT83.pairKernel_zero_eq, COLT83.not_isPAC_unitBall_of_isFixedBudget_zero}\leanok
