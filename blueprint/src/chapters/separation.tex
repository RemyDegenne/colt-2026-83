...
\lean{COLT83.blockBallSet}\leanok
\uses{def:arm_set}
...
\lean{COLT83.blockBallSet_le_budget_of_isFixedDesign_of_isPAC, COLT83.blockBallSet_le_budget_of_isPAC}\leanok
...
\lean{COLT83.exists_isPAC_blockBallSet}\leanok
...
\begin{proof}
\uses{thm:separation}
Take the block algorithm of Theorem~\ref{thm:separation}.
\end{proof}
