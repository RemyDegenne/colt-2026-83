...
\lean{ProbabilityTheory.isGaussian_prod_stdGaussian, ProbabilityTheory.covariance_inner_add_prod_stdGaussian, ProbabilityTheory.stdGaussian_map_blocks}\leanok
\uses{def:pg_gaussian_vector}
