...
\lean{COLT83.radDir, COLT83.radDir_mem_unitBall, COLT83.measurable_radDir}\leanok
\uses{def:arm_set}
...
\lean{COLT83.inner_radDir, COLT83.card_mul_inner_radDir_sq, COLT83.norm_radDir_le_one}\leanok
...
\lean{COLT83.rbMeasure, COLT83.rbMean, COLT83.rbStat, COLT83.rbX, COLT83.rbW, COLT83.rbStat_sub_sq_eq}\leanok
...
\lean{COLT83.nsMeasure, COLT83.rbProj, COLT83.nsMeasure_map_rbProj, COLT83.indepFun_prefix_rbProj, COLT83.lnProj, COLT83.nsMeasure_map_lnProj, COLT83.indepFun_prefix_lnProj, ProbabilityTheory.indepFun_prefix_window, MeasureTheory.Measure.infinitePi_map_eval_comp, MeasureTheory.Measure.infinitePi_map_eval_comp', COLT83.shiftSeq, COLT83.nsMeasure_map_shiftSeq, COLT83.winStat, COLT83.winStat_eq_rbStat}\leanok
...
\lean{COLT83.hasSubexponentialMGF_rbX, COLT83.iIndepFun_rbX, COLT83.rbX_eq_zero_of_eq_zero}\leanok
...
\lean{COLT83.rbMeasure_real_avg_rbX_gt_le}\leanok
...
\lean{COLT83.rbNoise, COLT83.hasLaw_sqrt_mul_rbMean, COLT83.hasSubexponentialMGF_rbW, COLT83.iIndepFun_rbW}\leanok
\uses{def:squared_statistic, lem:statistic_structure, def:subexp}
...
\lean{COLT83.rbVbar, COLT83.sum_rbVbar_eq, COLT83.rbNoise_real_avg_rbW_ge_le, COLT83.rbMeasure_real_avg_rbW_gt_le}\leanok
...
\lean{COLT83.rbMeasure_real_rbVbar_gt_le}\leanok
...
\lean{COLT83.addS, COLT83.addK}\leanok
...
\lean{COLT83.rbMeasure_real_addEst_gt_le, COLT83.rbMeasure_real_sqrt_addEst_gt_le, COLT83.NormEstParam.s'_mul_K'_le}\leanok
...
\lean{COLT83.testS, COLT83.testK}\leanok
...
\lean{COLT83.testS_facts, COLT83.testK_facts, COLT83.six_mul_exp_neg_le, COLT83.rbMeasure_real_test_h0_le}\leanok
\uses{def:scale_test}
...
\lean{COLT83.rbMeasure_real_test_h1_le}\leanok
\uses{def:scale_test}
...
\lean{COLT83.nsScale, COLT83.nsDelta, COLT83.nsS, COLT83.nsK, COLT83.nsJ, COLT83.nsStart, COLT83.one_le_nsJ, COLT83.nsScale_nsJ_lt, COLT83.NormEstParam.testStat, COLT83.NormEstParam.testH1, COLT83.NormEstParam.jStar}\leanok
\uses{def:scale_test}
...
\lean{COLT83.NormEstParam.testOK, COLT83.NormEstParam.badTest, COLT83.NormEstParam.nsMeasure_real_badTest_le, COLT83.NormEstParam.bad, COLT83.NormEstParam.nsMeasure_real_bad_le, COLT83.sum_nsDelta_le}\leanok
...
\lean{COLT83.NormEstParam.jStar_bounds}\leanok
...
\lean{COLT83.sum_pow_le, COLT83.sum_mul_pow_le, COLT83.NormEstParam.s_le, COLT83.NormEstParam.K_le, COLT83.NormEstParam.T₁_le}\leanok
...
\lean{COLT83.lnN, COLT83.lnNoise, COLT83.lnDelta, COLT83.lnR, COLT83.lnEst}\leanok
...
\lean{COLT83.lnR_sub_eq, COLT83.hasLaw_two_mul_inner_lnDelta, COLT83.lnG, COLT83.hasLaw_lnG, COLT83.norm_lnDelta_sq_sub_eq, COLT83.hasSubexponentialMGF_lnQ}\leanok
...
\lean{COLT83.lnNoise_real_lnEst_gt_le, COLT83.NormEstParam.n_le}\leanok
...
\lean{COLT83.NormEstParam, COLT83.nsN2, COLT83.nsBudget, COLT83.NormEstParam.T, COLT83.NormEstParam.phaseOf, COLT83.NormEstParam.rbBlock, COLT83.NormEstParam.basisRound, COLT83.NormEstParam.planAction, COLT83.NormEstParam.nextAction, COLT83.NormEstParam.alg, COLT83.NormEstParam.addStat, COLT83.NormEstParam.lnRStat, COLT83.NormEstParam.estimate, COLT83.NormEstParam.output}\leanok
...
\texttt{alg} has \texttt{next}$_n(h, u) = \mathrm{nextAction}(n+1, \mathrm{past}(h), j_*(h), u)$.
...
\lean{COLT83.NormEstParam.seedAction_eq_planAction, COLT83.NormEstParam.yω_eq, COLT83.NormEstParam.testStat_eq_rbStat, COLT83.NormEstParam.addStat_eq_rbStat, COLT83.NormEstParam.lnRStat_eq_lnR, COLT83.NormEstParam.estimate_congr, COLT83.NormEstParam.estimate_yOf_seedFinHist, COLT83.NormEstParam.jsω_prefixExtend}\leanok
...
\lean{COLT83.NormEstParam.fail2, COLT83.NormEstParam.fail_subset, COLT83.NormEstParam.nsMeasure_real_jsω_inter_preimage_eq_mul, COLT83.NormEstParam.nsMeasure_real_fail2_le, COLT83.NormEstParam.nsMeasure_real_estimate_fail_le, COLT83.NormEstParam.one_sub_le_seedMeasure_real_output, COLT83.NormEstParam.N₂_le, COLT83.NormEstParam.T_le}\leanok
