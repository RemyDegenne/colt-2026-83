...
\lean{COLT83.gw_le_card, COLT83.IsGOptimalDesign.gwMat_le_card}\leanok
...
\lean{COLT83.gw_le_sqrt_log_ncard, COLT83.IsGOptimalDesign.gwMat_le_sqrt_log_ncard}\leanok
\uses{def:width, thm:kiefer_wolfowitz}
...
\lean{COLT83.regionalizedGw, COLT83.gwMat_le_regionalizedGw, COLT83.regionalizedGw_le, COLT83.regionalizedGw_nonneg, COLT83.regionalizedGw_le_gwMat}\leanok
...
\lean{COLT83.IsGOptimalDesign.regionalizedGw_le_sqrt_log}\leanok
...
\lean{COLT83.gwMat_unitBall, COLT83.one_le_sqrt_diag_mul_sqrt_diag_inv, COLT83.le_gwMat_unitBall, COLT83.le_gw_unitBall, COLT83.div_sqrt_three_le_gw_unitBall, COLT83.gw_unitBall_le_card}\leanok
\uses{def:width}
...
\lean{exists_pos_weight_sq_dist_ge_of_isotropic, exists_separated_of_isotropic, COLT83.sum_mul_inner_sqrt_inv_sq}\leanok
...
(\texttt{COLT83/Mathlib/Analysis/InnerProductSpace/IsotropicSeparated.lean}): for a weighted
...
\lean{COLT83.sqrt_log_le_gw}\leanok
\uses{def:width}
...
(Lean: \texttt{COLT83.sqrt\_log\_le\_gwMat}, for every design $\lambda$ with $A(\lambda)\succ0$).
...
\lean{COLT83.intrinsicGw}\leanok
...
\lean{COLT83.multitaskSet, COLT83.oneHot, COLT83.multitaskSet_eq_range, COLT83.ncard_multitaskSet, COLT83.supportFn_multitaskSet, COLT83.norm_le_of_mem_multitaskSet}\leanok
...
\lean{COLT83.mem_span_multitaskSet_iff, COLT83.finrank_span_multitaskSet_add, COLT83.single_sub_single_mem_span, COLT83.blockSum}\leanok
...
\lean{COLT83.unifDesignMatrix, COLT83.unifDesignMatrix_mem_designSet, COLT83.toEuclideanLin_unifDesignMatrix_muVec, COLT83.toEuclideanLin_unifDesignMatrix_blockCenter, COLT83.blockCenter, COLT83.muVec, COLT83.kappa}\leanok
...
\lean{COLT83.intrinsicGw_le_gaussianWidth, COLT83.intrinsicGw_eq_gw_image, COLT83.spanBasisMatrix, COLT83.mtL, COLT83.mtS, COLT83.multivariateGaussian_mtS, COLT83.toEuclideanLin_unifDesignMatrix_mtL_mtL, COLT83.mtL_apply_mk}\leanok
...
\lean{COLT83.integral_iSup_mtL_le, ciSup_const_add_const_mul}\leanok
...
\lean{COLT83.intrinsicGw_multitaskSet_le}\leanok
...
\lean{COLT83.width_separation}\leanok
