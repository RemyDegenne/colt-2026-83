...
\texttt{IsAlgEnvSeq.hasCondDistrib\_feedback n : HasCondDistrib (Y n) ((history O A Y n, O n), A n) (env.feedback n) P},
...
\texttt{trajMeasure} under the restriction of histories). The conditional statement and the
